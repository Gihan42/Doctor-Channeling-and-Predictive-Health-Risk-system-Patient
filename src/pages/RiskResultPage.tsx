...
Please provide personalized advice based on this risk assessment.`;
  ...
  const formatChatResponse = (response: string) => {
  ...
  const getChatResponse = async () => {
    ...
    try {
      ...
      setChatResponse(formatChatResponse(data.response));
    } catch (err) {
              ...
              {isLoading ? (
                  ...
                  <div className="max-h-96 overflow-y-auto">
                    ...
                    <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-4 mb-4">
                      <div className="flex items-start">
                        <AlertTriangleIcon className="h-5 w-5 text-yellow-600 mt-0.5 mr-3 flex-shrink-0" />
                        <div className="text-left">
                          <h4 className="font-semibold text-yellow-800 mb-1">Important Disclaimer</h4>
                          <p className="text-yellow-700 text-sm">
                            This advice is generated by an AI assistant and is not a substitute for professional medical advice. 
                            I am not a doctor. Please consult with a qualified healthcare professional for diagnosis and treatment recommendations.
                          </p>
                        </div>
                      </div>
                    </div>
                    ...
                    <div className="bg-gray-50 rounded-lg p-4">
                      ...
                      <div className="text-left space-y-4 bg-white p-4 rounded border">
                        {chatResponse.split('\n\n').map((paragraph, index) => (
                  ...
                  <div>
                    ...
                    <p className="text-gray-500 mb-4">
                      Click below to get AI-generated advice based on your risk assessment.
                    </p>
                    <button
